module.exports = { 
    async msg(chats) {
        ...
        try {
            ...
            if (message.startsWith(prefix)) console.log('\x1b[1;37m> [' + Ft.color('CMD') + ']', Ft.color(Ft.moment.tz('Asia/Jakarta').format('DD/MM/YYYY HH:mm'), 'cyan'), Ft.color('Command'), 'Dari', Ft.color(await this.getName(m.sender)))
            else console.log('\x1b[1;37m> [' + Ft.color('MSG') + ']', Ft.color(Ft.moment.tz('Asia/Jakarta').format('DD/MM/YYYY HH:mm'), 'cyan'), Ft.color('Message'), 'Dari', Ft.color(await this.getName(m.sender)))
